#!/bin/bash
# Hardware requirements: Amazon Linux 2 Kernel 5.10 AMI with minimum t2.medium type instance & port 8080(jenkins), 9100 (node-exporter) should be allowed on the security groups
